...
Main contain START -->
		<div class="row g-4">
			...
			<div class="col-xl-8">
				...
				<?php
						$result = Db::selectLimited('noticias', 1, 5, 'titulo', 'DESC');
...
<!-- Table item --><tr>
										<td><h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">12 worst types of business accounts you follow on Twitter</a></h6></td>
										<td>Jan 22, 2022</td>
										<td><a href="#" class="badge text-bg-warning mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a></td>
										<td><div class="d-flex gap-2">
                        <a href="#" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class="bi bi-pencil-square"></i></a>
                        ...
                        <a href="#" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Compartilhar"><i class="bi bi-whatsapp"></i></a>
                      </div>
										</td>
									</tr>
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									...
									<div class="ms-3">
										...
										<p class="small mb-0">Jun 17, 2022 - ## visualizações</p>
									</div>
								</div>
							</div>
							<!-- Divider -->
	...
	if(isset($_SESSION['id_usuario']) && is_numeric($_SESSION['id_usuario'])){
		if(($_SESSION["nivel"] >= "1") && ($_SESSION["nivel"] <= "49")){
			...
			for($i = 0;$i<$paginas;$i++){
				...
				$url = "https://www.canalicara.com/portal/portal_admin.php?action=mostrarnews&pagina=$i";
