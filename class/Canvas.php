 ...
 * 
 * Modificado por Matheus Reus Vieira <matheus.reusv@gmail.com> no dia 2023-01-26 23:15
 */
...
class Canvas
{
    ...
    private function dados()
    {
        ...
        if (is_file($this->origem)) {
            ...
            if (!$this->eImagem()) {
                trigger_error('Erro: Arquivo ' . pathinfo($this->origem)['basename'] . ' não é uma imagem!', E_USER_ERROR);
            } else {
